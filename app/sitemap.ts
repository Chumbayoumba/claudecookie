...
const ROUTES = [
  ...
  { path: '/claude-code-login', priority: 0.8, changeFrequency: 'monthly' as const, lastModified: '2026-09-20' },
  { path: '/claude-usage-limits', priority: 0.8, changeFrequency: 'monthly' as const, lastModified: '2026-09-20' },
