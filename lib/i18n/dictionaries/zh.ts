...
export const zh: Dictionary = {
  ...
  converter: {
    ...
    sample: '示例',
    upload: '上传',
    dropHere: '放开 cookies.txt',
    dropHint: '我们会自动识别格式',
    placeholder: '在这里粘贴 Cookie',
    emptyHintWin: 'Ctrl+V、拖入文件，或浏览',
    emptyHintMac: '⌘V、拖入文件，或浏览',
    formatsChip: 'Netscape · JSON · Cookie header',
    chooseFile: '选择文件',
    staysInBrowser: '只留在这个浏览器',
    localTooltip: '转换在本地完成，内容不会发到服务器。',
    localBadge: 'Local',
    tryExample: '试试示例：',
    autoDetects: '自动识别输入格式',
    outputReady: '就绪',
    outputPlaceholder: '转换后的 Cookie 会显示在这里。',
