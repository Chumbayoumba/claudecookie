...
export const zh: Dictionary = {
  ...
  converter: {
    ...
    sample: '示例',
    upload: '上传',
    dropHere: '放开 Cookie 文件',
    dropHint: '我们会自动识别格式',
    placeholder: '在这里粘贴 Cookie',
    emptyHintWin: 'Ctrl+V 或拖入文件',
    emptyHintMac: '⌘V 或拖入文件',
    formatsChip: 'Netscape · JSON · Cookie header',
    chooseFile: '选择文件',
    staysInBrowser: '在浏览器本地处理',
    localTooltip: '输入不会离开这个浏览器。',
    localBadge: 'Local',
    tryExample: '试试示例：',
    autoDetects: '输入格式会自动识别',
    outputReady: '就绪',
    outputPlaceholder: '结果会显示在这里',
    outputEmptyHint: '在左侧粘贴，结果会显示在这里。',
    outputReadyConvert: '可以转换',
    tabsMore: '更多',
    convertHintWin: 'Ctrl+Enter 转换',
    convertHintMac: '⌘Enter 转换',
    defaultDomain: '默认域名',
    defaultDomainHint:
  ...
  check: {
    ...
    placeholder: 'Netscape cookies.txt 或 JSON 数组。需要 sessionKey / sessionKeyV3。可粘贴多条或拖入文件批量检测。',
    submit: '检测会话',
    checking: '正在检查…',
    clear: '清空',
    batchHeading: '已检测',
