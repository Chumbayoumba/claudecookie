...
export const en = {
  ...
  converter: {
    ...
    sample: 'Sample',
    upload: 'Upload',
    dropHere: 'Drop cookies.txt',
    dropHint: "We'll detect the format automatically",
    placeholder: 'Paste your cookies here',
    emptyHintWin: 'Ctrl+V, drop a file, or browse',
    emptyHintMac: '⌘V, drop a file, or browse',
    formatsChip: 'Netscape · JSON · Cookie header',
    chooseFile: 'Choose a file',
    staysInBrowser: 'Stays in this browser',
    localTooltip: "Converter input is processed locally and isn't sent to the server.",
    localBadge: 'Local',
    tryExample: 'Try an example:',
    autoDetects: 'Auto-detects your input',
    outputReady: 'Ready',
    outputPlaceholder: 'Your converted cookies will appear here.',
